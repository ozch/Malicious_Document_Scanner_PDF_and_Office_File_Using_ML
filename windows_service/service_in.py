...
# sc create nonpe binPath= "C:\Services\service_in.exe" DisplayName= "Non PE" start= auto
class NonPEService(win32serviceutil.ServiceFramework):
    _svc_name_ = 'nonpe'
    _svc_display_name_ = 'Non PE'
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        servicemanager.PrepareToHostSingle(NonPEService)
        servicemanager.StartServiceCtrlDispatcher()
    else:
        win32serviceutil.HandleCommandLine(NonPEService)
